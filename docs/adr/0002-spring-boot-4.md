...
## Decision
Spring Boot **4.1.0**, Java 21. *(Amended 2026-07-26: bumped to **Java 25 LTS** at the user's request — host JDK 25 installed; Boot 4 / Framework 7 support JDK 17–25.)* Deltas absorbed (verified facts in `docs/design/spring-boot-4-facts.md`):
