...
- Phase 1 acceptance for the sensor chart is verified with fake telemetry (`deploy/scripts/fake-node-sensor.sh`); the real-sensor check happens when hardware arrives (wire SDA=GPIO8, SCL=GPIO9, reboot — the capability auto-appears).
