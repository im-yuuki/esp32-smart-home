...
<template>
  ...
  <UApp :locale="uiLocale">
    <div class="min-h-screen bg-default text-default">
      ...
      <div v-if="showShell" class="flex min-h-[calc(100dvh-3.5rem)]">
        <div class="sticky top-14 hidden h-[calc(100dvh-3.5rem)] shrink-0 lg:block"><FacilitySidebar :collapsed="collapsed" /></div>
        <main id="main-content" class="min-w-0 flex-1"><RouterView /></main>
      </div>
